...
def cnn_model_2h(input_shape, num_sensors, num_classes, time_step):
    ...
    dropout_accel = Dropout(0.5) (gap_accel)
    #Gyroscop Head
    ...
    dropout_gyro = Dropout(0.5) (gap_gyro)
    #stack
    stacked_features = concatenate([dropout_accel, dropout_gyro])
    dense = Dense(64, activation='relu') (stacked_features)
